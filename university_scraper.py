...
class UniversityScraper:
    def __init__(self, faculty_path: str):
        ...
        self.driver.get(faculty_path) #Ex: https://cse.engin.umich.edu/people/faculty/core-cse-faculty/"
...
FACULTY_PATH: str = "https://cse.engin.umich.edu/people/faculty/core-cse-faculty/"

scraper: UniversityScraper = UniversityScraper(FACULTY_PATH)
UniversityScraper.findFacultyUMichExample(scraper.soup)